-- Team OKR model: Objectives per commitment, Key Results per objective.
-- Migrates legacy Primary Outcome + SupportingSignal into Objective + KeyResult.
...
-- ─── SupportingSignal → KeyResult (same Objective) ─────────────────────────
...
-- ─── GripSession: keyResultSnapshots ─────────────────────────────────────────
